import { create, defineProperty, entries, hasOwn, keys } from '../../helpers/utils.js';
...
export function createVmContext(
    vmValues?: VmContextRecordLoose | null,
...
/** 创建用于执行脚本的执行上下文 */
export function createVmContext(
    arg0: VmContextRecordLoose | ((key: string) => VmValue | undefined) | null = null,
