...
export const trunc = build(Math.trunc, '向零方向舍入数值');
export const floor = build(Math.floor, '向下舍入数值');
export const ceil = build(Math.ceil, '向上舍入数值');
const _round = Math.round;
const _abs = Math.abs;
export const round = build((x) => {
